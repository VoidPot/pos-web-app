...
function BrandStack({ className, fillClass }: BrandSvgProps) {
  const [classOne, classTwo] = extractClassNames(fillClass);
  return (
    <svg viewBox="0 0 350 252.32961317197189" className={clsx(className)}>
      <g
        transform="matrix(1.5555555555555556,0,0,1.5555555555555556,97.22222222222223,-19.444441477457683)"
        className={clsx({
      ...
      <g
        transform="matrix(3.428347659466981,0,0,3.428347659466981,-4.7996911371153725,113.96150444767785)"
        className={clsx({
